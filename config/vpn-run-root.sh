...
[ -z 2080 ] && echo "Please set env PORT" && exit
...
start() {
  ...
  "I:/nekoray/nekobox_core" run -c "I:/nekoray/config/sing-box-vpn.json" --protect-listen-path "I:/nekoray/config/protect" --protect-fwmark 514
}
